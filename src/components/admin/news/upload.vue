<template>
  <div style="padding: 20px 20px 40px 20px;width: 60%">
    ...
    <el-button
      style="min-width: 200px;margin-top: 20px;background-color: #1e56a0;color: white"
