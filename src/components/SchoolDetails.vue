<template>
    <div>
        <div class="choose" style="display: flex;flex-direction: column;justify-content: space-around">
            <div style="width: 60px"><el-input style="width: 250px;" v-model="input" placeholder="模糊查询" clearable></el-input></div>
            <div style="display: flex;align-items: center;">
                <p style="margin-right: 10px">排名筛选:</p>
            ...
            <el-button style="width: 150px">查询</el-button>
        </div>
