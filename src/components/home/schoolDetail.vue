<template>
  <div>
    <div class="choose" style="display: flex;flex-direction: column;justify-content: space-around">
      <div style="width: 60px"><el-input size="small" style="width: 200px;" v-model="input" placeholder="模糊查询" clearable></el-input></div>
      <div style="display: flex;align-items: center;">
        <p style="margin-right: 10px;padding-left: 0">排名筛选 : </p>
        <el-dropdown style="margin-right: 10px" size="small" split-button trigger="click" @command="handleCommand">
          {{rank_sys}}
    ...
    <div class="result" style="margin-top: 50px">
      <el-table :data="tabledata" @row-click="schoolclik" :header-cell-style="{background:'#eef1f6',color:'#606266'}" border stripe>
